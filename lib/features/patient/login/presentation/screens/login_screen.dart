        ...
        child: Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [
                const Color.fromARGB(255, 246, 251, 255),
                const Color.fromARGB(255, 117, 197, 209),
              ],
            ),
          ),
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(
                                  color: const Color.fromARGB(255, 54, 124, 150)
                                      .withOpacity(0.2),
                                  blurRadius: 15,
                                  spreadRadius: 3,
                                ),
                            ...
                            child: const Icon(Icons.medical_services_rounded,
                                size: 60,
                                color: Color.fromARGB(255, 17, 86, 103)),
                          ),
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(
                                  color: const Color.fromARGB(255, 18, 131, 144)
                                      .withOpacity(0.1),
                                  blurRadius: 8,
                                  spreadRadius: 1,
                                ),
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(
                                  color: const Color.fromARGB(255, 19, 104, 121)
                                      .withOpacity(0.1),
                                  blurRadius: 20,
                                  spreadRadius: 5,
                                ),
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                TextButton(
                                  ...
                                  style: TextButton.styleFrom(
                                    foregroundColor:
                                        const Color.fromARGB(255, 20, 199, 226),
                                    padding: const EdgeInsets.symmetric(
                                        horizontal: 8),
